...
class PropertyComparator<R, T extends Comparable<? super T>> {
    ...
    /**
     * Creates a specification that compares the specified right expression to the
     * instance's entity path by using given operator.
     *
     ...
     * @see #compare(Expression, ComparisonOperator, Expression, CriteriaBuilder)
    ...
    /**
     * Creates a specification that compares the specified left expression to the
     * instance's entity path by using given operator.
     *
     ...
     * <p>
     * Delegates to
     * {@link #compare(Expression, ComparisonOperator, Expression, CriteriaBuilder)}.
     *
     ...
     * <li>{@link ComparisonOperator#PropertyIsLessThanOrEqualTo
     * PropertyIsLessThanOrEqualTo}
     * <li>{@link ComparisonOperator#PropertyIsGreaterThan PropertyIsGreaterThan}
     * <li>{@link ComparisonOperator#PropertyIsGreaterThanOrEqualTo
     * PropertyIsGreaterThanOrEqualTo}
     * </ul>
     * <p>
     * Throws in case of unsupported operation, for example
     * {@link ComparisonOperator#PropertyIsBetween PropertyIsBetween}.
     *
    ...
    <Y extends Comparable<? super Y>> Predicate compare(
            ...
            CriteriaBuilder builder) throws SpecificationsException {
