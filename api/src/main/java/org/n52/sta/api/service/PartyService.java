...
public class PartyService extends AbstractEntityService<Party> {
    ...
    protected EntityAggregate<Party> createAggregate(Party entity) {
        return new PartyAggregate(entity, editor.orElse(null));
    }
