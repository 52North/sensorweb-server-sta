...
/**
 * Java Bean implementation of {@code AbstractPageRequest} to support offset and limit instead of page and
 * size.
 *
...
public class OffsetLimitBasedPageRequest extends AbstractPageRequest {
    ...
    /**
     * Creates a new {@link OffsetLimitBasedPageRequest}. Pages are zero indexed, thus providing 0 for
    ...
    /**
     * Creates a new {@link OffsetLimitBasedPageRequest} with sort parameters applied.
     *
     * @param offset
     *        zero-based offset index.
     * @param limit
