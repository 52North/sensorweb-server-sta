...
public class AggregataObservationService
    extends ObservationService {

    protected static final String SLASH = "/";
    private static final String NOT_YET_IMPLEMENTED = "not yet implemented";
    private static final Logger LOGGER = LoggerFactory.getLogger(AggregataObservationService.class);
    private static final String TARGET = "target";
    Pattern longNamePattern = Pattern.compile(".+\\s\\((.*)\\).*");
        ...
        try {
            ...
            if (relatedType.equals(StaConstants.DATASTREAMS)) {
                ...
                ProcedureEntity sensor =
                    sensorService.getEntityByRelatedEntityRaw(relatedId, relatedType, null, new QueryOptions("", null));
                ...
                List<ElementWithQueryOptions> observations = new ArrayList<>();
