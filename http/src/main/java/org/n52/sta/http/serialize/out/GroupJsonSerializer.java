...
public class GroupJsonSerializer extends StaBaseSerializer<Group> {

    public GroupJsonSerializer(SerializationContext context) {
        super(context, StaConstants.GROUPS, Group.class);
    }
    ...
    public void serialize(Group value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
        ...
        writeStringProperty(StaConstants.PROP_PURPOSE, value::getPurpose, gen);
