...
public class CitSciEntityRequestHandler extends AbstractEntityRequestHandler implements CitSciExtensionRequestUtils {

    public CitSciEntityRequestHandler(EntityServiceRepository serviceRepository) {
