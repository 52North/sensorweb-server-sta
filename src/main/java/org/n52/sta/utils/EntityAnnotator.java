...
public class EntityAnnotator {
    ...
    public Entity annotateEntity(Entity entity, EdmEntityType entityType) {
        entity.addProperty(new Property(null, SELF_LINK_ANNOTATION, ValueType.PRIMITIVE, entity.getId().getPath()));
        ...
        entityType.getNavigationPropertyNames().forEach(np -> {
            ...
            String navigationAnnotationValue = String.join("/", entity.getId().getPath(), navProp.getName());
