...
import org.n52.sta.data.old.query.SensorQuerySpecifications;
...
import org.n52.sta.data.old.repositories.ProcedureHistoryRepository;
import org.n52.sta.data.old.repositories.ProcedureParameterRepository;
import org.n52.sta.data.old.repositories.ProcedureRepository;
...
public class SensorService
    ...
    public ProcedureEntity createOrfetch(ProcedureEntity sensor) throws STACRUDException {
        ...
        synchronized (getLock(sensor.getStaIdentifier())) {
            ...
            // Intermediate save to allow DatastreamService->createOrUpdate to use this
            // entity. Does not trigger
            // intercept handling (e.g. mqtt). Needed as Datastream<->Procedure connection
            // is not yet set but
    ...
    @Override
    public ProcedureEntity updateEntity(String id, ProcedureEntity entity, String method) throws STACRUDException {
        checkUpdate(entity);
