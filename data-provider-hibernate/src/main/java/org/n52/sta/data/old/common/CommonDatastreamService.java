...
public abstract class CommonDatastreamService<S extends AbstractDatasetEntity, T extends StaIdentifierRepository<S> & AggregateRepository<S>>
    ...
    /**
     * Constructs FilterPredicate based on given queryOptions. Additionally filters
     * out Datasets that are aggregated
    ...
    /**
     * Creates a DatasetAggregation or expands the existing Aggregation with a new
     * dataset.
     *
