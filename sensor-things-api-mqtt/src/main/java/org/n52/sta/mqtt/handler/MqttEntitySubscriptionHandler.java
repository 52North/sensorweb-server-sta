...
public class MqttEntitySubscriptionHandler
        extends AbstractEntityRequestHandler<SensorThingsMqttRequest, MqttEntitySubscription> {

    @Autowired
    private UriResourceNavigationResolver navigationResolver;

    @Override
    public MqttEntitySubscription handleEntityRequest(SensorThingsMqttRequest request)
    ...
    private MqttEntitySubscription createResponseForEntity(String topic, List<UriResource> resourcePaths)
            throws ODataApplicationException {
        ...
        return new MqttEntitySubscription(
                responseEntity.getProperty(AbstractSensorThingsEntityProvider.PROP_ID)
                              .getValue()
                              .toString(),
    ...
    private MqttEntitySubscription createResponseForNavigation(String topic, List<UriResource> resourcePaths)
            throws ODataApplicationException {
