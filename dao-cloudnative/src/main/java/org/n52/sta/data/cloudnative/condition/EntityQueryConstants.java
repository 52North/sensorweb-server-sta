...
public interface EntityQueryConstants {
    ...
    String OBSERVATION_PHENOMENONTIME_START_FIELD = "sampling_time_start";
    String OBSERVATION_PHENOMENONTIME_END_FIELD = "sampling_time_end";
    String OBSERVATION_VALIDTIME_START_FIELD = "valid_time_start";
    String OBSERVATION_VALIDTIME_END_FIELD = "valid_time_end";
    ...
    String DATASTREAM_RESULTTIME_END_FIELD = "result_time_end";
    String DATASTREAM_OBS_AREA_FIELD = "observed_area";
    String UNIT_SYMBOL_FIELD = "symbol";
    String UNIT_NAME_FIELD = STA_NAME_FIELD;
    String UNIT_LINK_FIELD = "link";
