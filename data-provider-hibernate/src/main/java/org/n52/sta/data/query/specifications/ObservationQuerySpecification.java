...
public class ObservationQuerySpecification implements BaseQuerySpecifications<DataEntity<?>> {

    private final Map<String, MemberFilter<DataEntity<?>>> filterByMember;

    private final Map<String, PropertyComparator<DataEntity<?>, ?>> entityPathByProperty;
