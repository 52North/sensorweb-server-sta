...
import org.n52.sta.data.old.query.QuerySpecificationFactory;
import org.n52.sta.data.old.query.SpatialQuerySpecifications;
...
public final class FilterExprVisitor<T> implements ExprVisitor<Expression<?>, STAInvalidQueryException> {
    ...
    public FilterExprVisitor(Root root, CriteriaQuery query, CriteriaBuilder builder)
        ...
        this.query = query;
        this.root = root;
        this.rootQS = QuerySpecificationFactory.getSpecification(root.getJavaType().getSimpleName());
    }
