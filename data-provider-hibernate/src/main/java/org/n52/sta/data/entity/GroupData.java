...
public class GroupData extends StaData<GroupEntity> implements Group {
    ...
    public Set<Relation> getRelations() {
        return toSet(data.getRelations(), relationEntity -> new RelationData(relationEntity, propertyMapping) {
        });
    }
    ...
    public Set<Observation> getObservations() {
        return toSet(data.getObservations(), dataEntity -> new ObservationData(dataEntity, propertyMapping));
    }
}
