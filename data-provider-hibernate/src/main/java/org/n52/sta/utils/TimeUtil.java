...
public interface TimeUtil {
    ...
    default DateTime createDateTime(Date date) {
        return new DateTime(date, DateTimeZone.UTC);
    }

    default Time createTime(DateTime time) {
     ...
     */
    default Time createTime(DateTime start, DateTime end) {
        if (start.equals(end)) {
    ...
    default Time parseTime(Object object) {
        if (object == null) {
            return null;
