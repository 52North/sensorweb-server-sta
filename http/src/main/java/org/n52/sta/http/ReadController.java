...
public abstract class ReadController<T extends Identifiable> {
    ...
    protected ReadController(EntityProvider<T> entityProvider, ControllerSettings settings) {
        Objects.requireNonNull(entityProvider, "entityProvider must not be null!");
        this.entityProvider = entityProvider;
        this.settings = Optional.ofNullable(settings).orElse(ControllerSettings.EMPTY);
    }
