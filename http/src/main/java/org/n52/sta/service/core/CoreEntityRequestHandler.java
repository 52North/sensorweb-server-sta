 ...
 */
@RestController
public class CoreEntityRequestHandler extends AbstractEntityRequestHandler implements CoreRequestUtils {

    public CoreEntityRequestHandler(EntityServiceRepository serviceRepository) {
