...
public interface CoreRequestUtils extends RequestUtils {
    ...
    String IDENTIFIED_BY_DATASTREAM_REGEX = StaConstants.DATASTREAMS
            + IDENTIFIER_REGEX
            + SLASH
            + ROUND_BRACKET_OPEN
            + StaConstants.SENSOR
    ...
    String IDENTIFIED_BY_OBSERVATION_REGEX = StaConstants.OBSERVATIONS
            + IDENTIFIER_REGEX
            + SLASH
            + ROUND_BRACKET_OPEN
    ...
    String IDENTIFIED_BY_HISTORICAL_LOCATION_REGEX = StaConstants.HISTORICAL_LOCATIONS
            + IDENTIFIER_REGEX
            + SLASH
            + ROUND_BRACKET_OPEN
            + StaConstants.THING
    ...
    String IDENTIFIED_BY_THING_REGEX = StaConstants.THINGS
            + IDENTIFIER_REGEX
            + SLASH
            + ROUND_BRACKET_OPEN
            + StaConstants.DATASTREAMS
    ...
    String IDENTIFIED_BY_LOCATION_REGEX = StaConstants.LOCATIONS
            + IDENTIFIER_REGEX
            + SLASH
            + ROUND_BRACKET_OPEN
            + StaConstants.THINGS
    ...
    String IDENTIFIED_BY_OBSERVED_PROPERTY_REGEX = StaConstants.OBSERVED_PROPERTIES
            + IDENTIFIER_REGEX
            + SLASH
            + StaConstants.DATASTREAMS;

    String IDENTIFIED_BY_FEATURE_OF_INTEREST_REGEX = StaConstants.FEATURES_OF_INTEREST
            + IDENTIFIER_REGEX
            + SLASH
            + StaConstants.OBSERVATIONS;

    // /Datastreams(52)
    String ENTITY_IDENTIFIED_DIRECTLY = PATH_ENTITY
            + BASE_COLLECTION_REGEX
            + CURLY_BRACKET_CLOSE
            + PATH_ID
            + IDENTIFIER_REGEX
            + DOLLAR
    ...
    String ENTITY_IDENTIFIED_BY_DATASTREAM = SOURCE_NAME_GROUP_START
            + StaConstants.DATASTREAMS
            + SOURCE_NAME_GROUP_END
            + SOURCE_ID_GROUP_START
            + IDENTIFIER_REGEX
            + SOURCE_ID_GROUP_END
            + SLASH
    ...
    String ENTITY_IDENTIFIED_BY_DATASTREAM_PATH_VARIABLE = PATH_ENTITY
            + StaConstants.DATASTREAMS
            + IDENTIFIER_REGEX
            + CURLY_BRACKET_CLOSE
            + PATH_TARGET
    ...
    String ENTITY_PROPERTY_IDENTIFIED_BY_DATASTREAM_PATH_VARIABLE = ENTITY_IDENTIFIED_BY_DATASTREAM_PATH_VARIABLE
            + SLASH
            + PATH_PROPERTY;

    // /Observations(52)/Datastream
    // /Observations(52)/FeatureOfInterest
    String ENTITY_IDENTIFIED_BY_OBSERVATION = SOURCE_NAME_GROUP_START
            + StaConstants.OBSERVATIONS
            + SOURCE_NAME_GROUP_END
            + SOURCE_ID_GROUP_START
            + IDENTIFIER_REGEX
    ...
    String ENTITY_IDENTIFIED_BY_OBSERVATION_PATH_VARIABLE = PATH_ENTITY
            + StaConstants.OBSERVATIONS
            + IDENTIFIER_REGEX
            + CURLY_BRACKET_CLOSE
            + PATH_TARGET
    ...
    String ENTITY_PROPERTY_IDENTIFIED_BY_OBSERVATION_PATH_VARIABLE = ENTITY_IDENTIFIED_BY_OBSERVATION_PATH_VARIABLE
            + SLASH
            + PATH_PROPERTY;

    // /HistoricalLocations(52)/Thing
    String ENTITY_IDENTIFIED_BY_HISTORICAL_LOCATION = SOURCE_NAME_GROUP_START
            + StaConstants.HISTORICAL_LOCATIONS
            + SOURCE_NAME_GROUP_END
            + SOURCE_ID_GROUP_START
            + IDENTIFIER_REGEX
    ...
    String ENTITY_IDENTIFIED_BY_HISTORICAL_LOCATION_PATH_VARIABLE = PATH_ENTITY
            + StaConstants.HISTORICAL_LOCATIONS
            + IDENTIFIER_REGEX
            + CURLY_BRACKET_CLOSE
            + PATH_TARGET
    ...
    String ENTITY_PROPERTY_IDENTIFIED_BY_HISTORICAL_LOCATION_PATH_VARIABLE = ENTITY_IDENTIFIED_BY_HISTORICAL_LOCATION_PATH_VARIABLE
            + SLASH
            + PATH_PROPERTY;

    // /Datastream(52)/Observations
    String COLLECTION_IDENTIFIED_BY_DATASTREAM = SOURCE_NAME_GROUP_START
            + StaConstants.DATASTREAMS
            + ROUND_BRACKET_CLOSE
            + SOURCE_ID_GROUP_START
            + IDENTIFIER_REGEX
    ...
    String COLLECTION_IDENTIFIED_BY_DATASTREAM_PATH_VARIABLE = PATH_ENTITY
            + StaConstants.DATASTREAMS
            + IDENTIFIER_REGEX
            + CURLY_BRACKET_CLOSE
            + PATH_TARGET
    ...
    // /Things(52)/Locations
    String COLLECTION_IDENTIFIED_BY_THING = SOURCE_NAME_GROUP_START
            + StaConstants.THINGS
            + SOURCE_NAME_GROUP_END
            + SOURCE_ID_GROUP_START
            + IDENTIFIER_REGEX
    ...
    String COLLECTION_IDENTIFIED_BY_THING_PATH_VARIABLE = PATH_ENTITY
            + StaConstants.THINGS
            + IDENTIFIER_REGEX
            + CURLY_BRACKET_CLOSE
            + PATH_TARGET
    ...
    String COLLECTION_IDENTIFIED_BY_LOCATION = SOURCE_NAME_GROUP_START
            + StaConstants.LOCATIONS
            + SOURCE_NAME_GROUP_END
            + SOURCE_ID_GROUP_START
            + IDENTIFIER_REGEX
    ...
    String COLLECTION_IDENTIFIED_BY_LOCATION_PATH_VARIABLE = PATH_ENTITY
            + StaConstants.LOCATIONS
            + IDENTIFIER_REGEX
            + CURLY_BRACKET_CLOSE
            + PATH_TARGET
    ...
    String COLLECTION_IDENTIFIED_BY_SENSOR = SOURCE_NAME_GROUP_START
            + StaConstants.SENSORS
            + SOURCE_NAME_GROUP_END
            + SOURCE_ID_GROUP_START
            + IDENTIFIER_REGEX
    ...
    String COLLECTION_IDENTIFIED_BY_SENSOR_PATH_VARIABLE = PATH_ENTITY
            + StaConstants.SENSORS
            + IDENTIFIER_REGEX
            + CURLY_BRACKET_CLOSE
            + PATH_TARGET
    ...
    String COLLECTION_IDENTIFIED_BY_OBSERVED_PROPERTY = SOURCE_NAME_GROUP_START
            + StaConstants.OBSERVED_PROPERTIES
            + SOURCE_NAME_GROUP_END
            + SOURCE_ID_GROUP_START
            + IDENTIFIER_REGEX
    ...
    String COLLECTION_IDENTIFIED_BY_OBSERVED_PROPERTY_PATH_VARIABLE = PATH_ENTITY
            + StaConstants.OBSERVED_PROPERTIES
            + IDENTIFIER_REGEX
            + CURLY_BRACKET_CLOSE
            + PATH_TARGET
    ...
    String COLLECTION_IDENTIFIED_BY_FEATURE_OF_INTEREST = SOURCE_NAME_GROUP_START
            + StaConstants.FEATURES_OF_INTEREST
            + SOURCE_NAME_GROUP_END
            + SOURCE_ID_GROUP_START
            + IDENTIFIER_REGEX
    ...
    String COLLECTION_IDENTIFIED_BY_FEATURE_OF_INTEREST_PATH_VARIABLE = PATH_ENTITY
            + StaConstants.FEATURES_OF_INTEREST
            + IDENTIFIER_REGEX
            + CURLY_BRACKET_CLOSE
            + PATH_TARGET
    ...
    String COLLECTION_IDENTIFIED_BY_HIST_LOCATION = SOURCE_NAME_GROUP_START
            + StaConstants.HISTORICAL_LOCATIONS
            + SOURCE_NAME_GROUP_END
            + SOURCE_ID_GROUP_START
            + IDENTIFIER_REGEX
    ...
    String COLLECTION_IDENTIFIED_BY_HIST_LOCATION_PATH_VARIABLE = PATH_ENTITY
            + StaConstants.HISTORICAL_LOCATIONS
            + IDENTIFIER_REGEX
            + CURLY_BRACKET_CLOSE
            + PATH_TARGET
    ...
    Pattern[] NAMED_COLL_PATTERNS = new Pattern[] {
        CP_BASE,
    ...
    Pattern EP_BASE = Pattern.compile(
                                      BASE_COLLECTION_REGEX_NAMED_GROUPS
                                              + WANTED_ID_GROUP_START
                                              + IDENTIFIER_REGEX
                                              + WANTED_ID_GROUP_END
                                              +
                                              DOLLAR);
    ...
    Pattern[] NAMED_ENTITY_PATTERNS = new Pattern[] {
        EP_BASE,
    ...
    Pattern PROP_PATTERN_BASE = Pattern.compile(
                                                BASE_COLLECTION_REGEX_NAMED_GROUPS
                                                        ...
                                                        + WANTED_ID_GROUP_END
                                                        +
                                                        PROPERTY_REGEX_NAMED_GROUPS
                                                        + DOLLAR);
    Pattern PROP_PATTERN_IDENT_BY_DATASTREAM = Pattern.compile(ENTITY_IDENTIFIED_BY_DATASTREAM
            + PROPERTY_REGEX_NAMED_GROUPS
            + DOLLAR);
    Pattern PROP_PATTERN_IDENT_BY_HIST_LOC = Pattern.compile(ENTITY_IDENTIFIED_BY_HISTORICAL_LOCATION
            + PROPERTY_REGEX_NAMED_GROUPS
            + DOLLAR);
    Pattern PROP_PATTERN_IDENT_BY_OBSERVATION = Pattern.compile(ENTITY_IDENTIFIED_BY_OBSERVATION
            + PROPERTY_REGEX_NAMED_GROUPS
            + DOLLAR);

    Pattern[] NAMED_PROP_PATTERNS = new Pattern[] {
        PROP_PATTERN_BASE,
    ...
    // OGC-15-078r6 14.2.4
    Pattern NAMED_SELECT_PATTER_BASE = Pattern.compile(BASE_COLLECTION_REGEX_NAMED_GROUPS
            + SELECT_REGEX_NAMED_GROUPS
            + DOLLAR);
    Pattern NAMED_SELECT_PATTER_IDENT_BY_DATASTREAM = Pattern.compile(COLLECTION_IDENTIFIED_BY_DATASTREAM
            + SELECT_REGEX_NAMED_GROUPS
            + DOLLAR);
    Pattern NAMED_SELECT_PATTER_IDENT_BY_FOI = Pattern.compile(COLLECTION_IDENTIFIED_BY_FEATURE_OF_INTEREST
            + SELECT_REGEX_NAMED_GROUPS
            + DOLLAR);
    Pattern NAMED_SELECT_PATTER_IDENT_BY_LOCATION = Pattern.compile(COLLECTION_IDENTIFIED_BY_LOCATION
            + SELECT_REGEX_NAMED_GROUPS
            + DOLLAR);
    Pattern NAMED_SELECT_PATTER_IDENT_BY_OBS_PROP = Pattern.compile(COLLECTION_IDENTIFIED_BY_OBSERVED_PROPERTY
            + SELECT_REGEX_NAMED_GROUPS
            + DOLLAR);
    Pattern NAMED_SELECT_PATTER_IDENT_BY_SENSOR = Pattern.compile(COLLECTION_IDENTIFIED_BY_SENSOR
            + SELECT_REGEX_NAMED_GROUPS
            + DOLLAR);
    Pattern NAMED_SELECT_PATTER_IDENT_BY_THING = Pattern.compile(COLLECTION_IDENTIFIED_BY_THING
            + SELECT_REGEX_NAMED_GROUPS
            + DOLLAR);

    Pattern[] NAMED_SELECT_PATTERNS = new Pattern[] {
    ...
    default STAInvalidUrlException validateURISyntax(String[] uriResources) {
        ...
        if (uriResources.length > 1) {
            ...
            for (int i = 0; i < uriResources.length; i++) {
                if (!BY_ID_PATTERN.matcher(uriResources[i])
                                  .matches()) {
                    ...
                    if (i > 0) {
                        ...
                        if (!(BY_DATASTREAM_PATTERN.matcher(resource)
                                                   .matches()
                                || BY_HIST_LOC_PATTERN.matcher(resource)
                                                      .matches()
                                || BY_LOCATION_PATTERN.matcher(resource)
                                                      .matches()
                                || BY_THING_PATTERN.matcher(resource)
                                                   .matches()
                                || BY_FOI_PATTERN.matcher(resource)
                                                 .matches()
                                || BY_OBSERVATION_PATTERN.matcher(resource)
                                                         .matches()
                                || BY_OBSER_PROP_PATTERN.matcher(resource)
                                                        .matches()
                                || BY_SENSOR_PATTERN.matcher(resource)
                                                    .matches()
                                || BY_OBSER_PROP_PATTERN.matcher(resource)
                                                        .matches())) {
