package org.n52.sta.cloudnative.dao.util;
...
import org.n52.sta.cloudnative.condition.*;



public abstract class FilterExprVisitor implements ExprVisitor<Field<?>, STAInvalidQueryException> {
