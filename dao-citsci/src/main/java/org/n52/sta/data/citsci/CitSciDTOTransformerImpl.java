 ...
 */
public class CitSciDTOTransformerImpl<R extends StaDTO, S extends HibernateRelations.HasId>
    implements DTOTransformer<R, S> {
    ...
    public CitSciDTOTransformerImpl(SerDesConfig config) {
        this.config = config;
    }
