 ...
 */
@RestController
public class CorePropertyRequestHandler extends AbstractPropertyRequestHandler implements CoreRequestUtils {

    public CorePropertyRequestHandler(EntityServiceRepository serviceRepository, ObjectMapper mapper) {
        super(serviceRepository, mapper);
    }

    @GetMapping(
            value = RequestUtils.MAPPING_PREFIX
                    + CoreRequestUtils.ENTITY_IDENTIFIED_DIRECTLY
                    + RequestUtils.SLASH
