...
public final class ProjectGraphBuilder extends GraphBuilder<ProjectEntity> {

    private ProjectGraphBuilder() {
        super(ProjectEntity.class);
    }

    private ProjectGraphBuilder(QueryOptions queryOptions) {
        super(ProjectEntity.class);
        addGraphText(GraphText.GRAPH_PARAMETERS);
        addUnfilteredExpandItems(queryOptions);
    }

    public static ProjectGraphBuilder createEmpty() {
        return new ProjectGraphBuilder();
    }

    public static ProjectGraphBuilder createWith(QueryOptions queryOptions) {
        return new ProjectGraphBuilder(queryOptions);
    }
