...
import org.n52.sta.data.common.OffsetLimitBasedPageRequest;
...
import org.n52.sta.data.common.repositories.LocationRepository;
import org.n52.sta.data.common.repositories.ObservationParameterRepository;
...
import org.n52.sta.data.common.support.HibernateSpatialCriteriaBuilderImpl;
...
public class ObservationService
    ...
    private DataEntity<?> updateEntity(String id, DataEntity<?> entity) throws STACRUDException {
    ...
    /**
     * We touch DataEntity->value here to make sure it is fetched from the
     * database and not lazy-loaded. We cannot fetch it ourselves as any
     * assignment to entity->value will update the database (issue delete+insert
     * statemenets).
     *
    ...
    /**
     * Handles updating the phenomenonTime field of the associated Datastream
     * when Observation phenomenonTime is updated or deleted
     *
    ...
    /**
     * Updates FirstValue/LastValue, FirstObservation/LastObservation, Geometry
     * of Dataset and DatasetAggregation
     *
