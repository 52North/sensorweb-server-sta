...
public class FilterExpressionVisitor implements ExpressionVisitor<Object> {
    ...
    private static final Logger logger = LoggerFactory.getLogger(FilterExpressionVisitor.class);

    private final String ERROR_TEMPLATE = "Could not convert %s to %s";
    ...
    public FilterExpressionVisitor(Class sourceType,
                                   AbstractSensorThingsEntityService service,
    ...
    private Object evaluateComparisonOperation(BinaryOperatorKind operator, Object left, Object right)
        ...
        if (left instanceof String || right instanceof String) {
            ...
            try {
                ...
                logger.trace("could not evaluate filter expression as foreign expression");
            }
            ...
            try {
                ...
                logger.trace("could not evaluate filter expression as datetime expression");
            }
            ...
            try {
                ...
                switch (operator) {
                    ...
                    default: {
                        throw new ODataApplicationException(
                                "Comparison of Timespans is currently implemented for EQ and NE operators.",
                                HttpStatusCode.BAD_REQUEST.getStatusCode(),
                                Locale.ENGLISH);
                    }
                }
            } catch (ODataApplicationException e) {
                logger.trace("could not evaluate filter expression as timespan expression");
            }
    ...
    private Date convertToDateTimeExpression(Object expr) throws ODataApplicationException {
        ...
        throw new ODataApplicationException(
                String.format(ERROR_TEMPLATE, expr.toString(), "DateTimeExpression"),
                HttpStatusCode.BAD_REQUEST.getStatusCode(),
                Locale.ENGLISH);
    }
     ...
     */
    private javax.persistence.criteria.Expression<String> convertToStringExpression(Object expr)
            throws ODataApplicationException {
        if (expr instanceof javax.persistence.criteria.Expression) {
            ...
            throw new ODataApplicationException(
                    String.format(ERROR_TEMPLATE, expr.toString(), "StringExpression"),
                    HttpStatusCode.BAD_REQUEST.getStatusCode(),
                    Locale.ENGLISH);
        }
    }
    ...
    private String convertToString(Object expr) throws ODataApplicationException {
        if (expr instanceof String) {
            ...
            throw new ODataApplicationException(
                    String.format(ERROR_TEMPLATE, expr.toString(), "String"),
                    HttpStatusCode.BAD_REQUEST.getStatusCode(),
                    Locale.ENGLISH);
        }
    }
     ...
     */
    private javax.persistence.criteria.Expression<Geometry> convertToGeometryExpression(Object expr)
            throws ODataApplicationException {
        if (expr instanceof javax.persistence.criteria.Expression) {
            // SubExpression
            ...
            throw new ODataApplicationException(
                    String.format(ERROR_TEMPLATE, expr.toString(), "GeometryExpression"),
                    HttpStatusCode.BAD_REQUEST.getStatusCode(),
                    Locale.ENGLISH);
        }
    }
    ...
    public Object visitMethodCall(MethodKind methodCall, List<Object> parameters) throws ExpressionVisitException,
        ...
        switch (methodCall) {
            ...
            case STARTSWITH:
                return criteriaBuilder.like(convertToStringExpression(arg1), arg2 + "%");
            case LENGTH:
                return criteriaBuilder.length(convertToStringExpression(arg1));
            case INDEXOF:
            ...
            case GEODISTANCE:
                return SpatialRestrictions.distanceWithin((String) arg1,
                                                          JTS.to((Geometry) arg2),
