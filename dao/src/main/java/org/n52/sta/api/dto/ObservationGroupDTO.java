 ...
 */
public interface ObservationGroupDTO extends StaDTO {
    ...
    Set<ObservationRelationDTO> getObservationRelations();

    void setObservationRelations(Set<ObservationRelationDTO> observationRelations);
