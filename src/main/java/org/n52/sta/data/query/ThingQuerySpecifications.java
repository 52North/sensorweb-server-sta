 ...
 *
 */
public class ThingQuerySpecifications {
    ...
    public BooleanExpression getDatastreamById(Long id) {
    ...
    public BooleanExpression getHistoricalLocationById(Long id) {
        HistoricalLocationQuerySpecification historicalLocationQS = new HistoricalLocationQuerySpecification();
