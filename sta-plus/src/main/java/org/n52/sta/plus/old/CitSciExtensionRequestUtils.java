...
public interface CitSciExtensionRequestUtils extends RequestUtils {
    ...
    String IDENTIFIED_BY_OBSERVATION_REGEX = OBSERVATIONS
            + IDENTIFIER_REGEX
            + SLASH
            + ROUND_BRACKET_OPEN
            + SUBJECTS
    ...
    String IDENTIFIED_BY_LICENSE_REGEX = LICENSES
            + IDENTIFIER_REGEX
            + SLASH
            + ROUND_BRACKET_OPEN
            + GROUPS
    ...
    String IDENTIFIED_BY_PARTY_REGEX = PARTIES
            + IDENTIFIER_REGEX
            + SLASH
            + ROUND_BRACKET_OPEN
            + DATASTREAMS
    ...
    String IDENTIFIED_BY_PROJECT_REGEX = PROJECTS
            + IDENTIFIER_REGEX
            + SLASH
            + ROUND_BRACKET_OPEN
            + DATASTREAMS
    ...
    String IDENTIFIED_BY_OBSERVATION_GROUP_REGEX = GROUPS
            + IDENTIFIER_REGEX
            + SLASH
            + ROUND_BRACKET_OPEN
            + RELATIONS
    ...
    String IDENTIFIED_BY_RELATION_REGEX = RELATIONS
            + IDENTIFIER_REGEX
            + SLASH
            + ROUND_BRACKET_OPEN
            + SUBJECT
    ...
    String IDENTIFIED_BY_DATASTREAM_REGEX = DATASTREAMS
            + IDENTIFIER_REGEX
            + SLASH
            + ROUND_BRACKET_OPEN
            + PROJECT
    ...
    String COLLECTION_IDENTIFIED_BY_OBSERVATIONRELATION = SOURCE_NAME_GROUP_START
            + RELATIONS
    ...
    String COLLECTION_IDENTIFIED_BY_OBSERVATIONRELATION_PATH_VARIABLE = PATH_ENTITY
            + RELATIONS
            + IDENTIFIER_REGEX
            + CURLY_BRACKET_CLOSE
            + PATH_TARGET
    ...
    String COLLECTION_IDENTIFIED_BY_OBSERVATION = SOURCE_NAME_GROUP_START
            + OBSERVATIONS
            + SOURCE_NAME_GROUP_END
            + SOURCE_ID_GROUP_START
            + IDENTIFIER_REGEX
    ...
    String COLLECTION_IDENTIFIED_BY_OBSERVATION_PATH_VARIABLE = PATH_ENTITY
            + OBSERVATIONS
            + IDENTIFIER_REGEX
            + CURLY_BRACKET_CLOSE
            + PATH_TARGET
    ...
    String COLLECTION_IDENTIFIED_BY_OBSERVATION_GROUP = SOURCE_NAME_GROUP_START
            + GROUPS
            + SOURCE_NAME_GROUP_END
            + SOURCE_ID_GROUP_START
            + IDENTIFIER_REGEX
    ...
    String COLLECTION_IDENTIFIED_BY_OBSERVATION_GROUP_PATH_VARIABLE = PATH_ENTITY
            + GROUPS
            + IDENTIFIER_REGEX
            + CURLY_BRACKET_CLOSE
            + PATH_TARGET
    ...
    String COLLECTION_IDENTIFIED_BY_PARTY = SOURCE_NAME_GROUP_START
            + PARTIES
            + SOURCE_NAME_GROUP_END
            + SOURCE_ID_GROUP_START
            + IDENTIFIER_REGEX
    ...
    String COLLECTION_IDENTIFIED_BY_PARTY_PATH_VARIABLE = PATH_ENTITY
            + PARTIES
            + IDENTIFIER_REGEX
            + CURLY_BRACKET_CLOSE
            + PATH_TARGET
    ...
    String COLLECTION_IDENTIFIED_BY_LICENSE = SOURCE_NAME_GROUP_START
            + LICENSES
            + SOURCE_NAME_GROUP_END
            + SOURCE_ID_GROUP_START
            + IDENTIFIER_REGEX
    ...
    String COLLECTION_IDENTIFIED_BY_LICENSE_PATH_VARIABLE = PATH_ENTITY
            + LICENSES
            + IDENTIFIER_REGEX
            + CURLY_BRACKET_CLOSE
            + PATH_TARGET
    ...
    String COLLECTION_IDENTIFIED_BY_PROJECT = SOURCE_NAME_GROUP_START
            + PROJECTS
            + SOURCE_NAME_GROUP_END
            + SOURCE_ID_GROUP_START
            + IDENTIFIER_REGEX
    ...
    String COLLECTION_IDENTIFIED_BY_PROJECT_PATH_VARIABLE = PATH_ENTITY
            + PROJECTS
            + IDENTIFIER_REGEX
            + CURLY_BRACKET_CLOSE
            + PATH_TARGET
    ...
    // /ObservationRelations(52)/ObservationGroup
    // /ObservationRelations(52)/Observation
    String ENTITY_IDENTIFIED_BY_OBSERVATIONRELATION = SOURCE_NAME_GROUP_START
            + RELATIONS
            + SOURCE_NAME_GROUP_END
            + SOURCE_ID_GROUP_START
            + IDENTIFIER_REGEX
    ...
    String ENTITY_IDENTIFIED_BY_OBSERVATIONRELATION_PATH_VARIABLE = PATH_ENTITY
            + RELATIONS
            + IDENTIFIER_REGEX
            + CURLY_BRACKET_CLOSE
            + PATH_TARGET
    ...
    String ENTITY_PROPERTY_IDENTIFIED_BY_OBSERVATIONRELATION_PATH_VARIABLE = ENTITY_IDENTIFIED_BY_OBSERVATIONRELATION_PATH_VARIABLE
            + SLASH
            + PATH_PROPERTY;
            ...
            for (int i = 0; i < uriResources.length; i++) {
                if (!BY_ID_PATTERN.matcher(uriResources[i])
                    ...
                    if (i > 0) {
                        ...
                        if (!(BY_OBSERVATION_GROUP_PATTERN.matcher(resource)
                                                          .matches()
                                || BY_LICENSE_PATTERN.matcher(resource)
                                                     .matches()
                                || BY_PARTY_PATTERN.matcher(resource)
                                                   .matches()
                                || BY_PROJECT_PATTERN.matcher(resource)
                                                     .matches()
                                || BY_DATASTREAM_PATTERN.matcher(resource)
                                                        .matches()
                                || BY_OBSERVATION_PATTERN.matcher(resource)
                                                         .matches()
                                || BY_RELATION_PATTERN.matcher(resource)
                                                      .matches())) {
