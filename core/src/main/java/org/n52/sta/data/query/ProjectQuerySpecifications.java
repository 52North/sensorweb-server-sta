...
public class ProjectQuerySpecifications extends EntityQuerySpecifications<Project> {
    ...
    @Override
    protected Specification<Project> handleRelatedPropertyFilter(String propertyName, Specification<?> propertyValue)
            throws STAInvalidFilterExpressionException {
        return null;
    }

    @Override protected Specification<Project> handleDirectPropertyFilter(String propertyName,
