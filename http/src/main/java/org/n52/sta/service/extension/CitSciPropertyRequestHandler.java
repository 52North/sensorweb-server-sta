...
public class CitSciPropertyRequestHandler extends AbstractPropertyRequestHandler
        implements CitSciExtensionRequestUtils {

    public CitSciPropertyRequestHandler(EntityServiceRepository serviceRepository, ObjectMapper mapper) {
