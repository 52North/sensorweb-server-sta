...
public class CoreCudRequestHandler<T extends HibernateRelations.HasId>
        extends AbstractCudRequestHandler<T>
        implements CoreRequestUtils {

    public CoreCudRequestHandler(EntityServiceRepository serviceRepository,
                                 ObjectMapper mapper) {
    ...
    @PatchMapping(
            value = "**/{collectionName:" + CoreRequestUtils.BASE_COLLECTION_REGEX + "}{id:" +
    ...
    @PatchMapping(
            value = {
                    RequestUtils.MAPPING_PREFIX + CoreRequestUtils.ENTITY_IDENTIFIED_BY_DATASTREAM_PATH_VARIABLE,
                    RequestUtils.MAPPING_PREFIX + CoreRequestUtils.ENTITY_IDENTIFIED_BY_OBSERVATION_PATH_VARIABLE,
                    RequestUtils.MAPPING_PREFIX +
                            CoreRequestUtils.ENTITY_IDENTIFIED_BY_HISTORICAL_LOCATION_PATH_VARIABLE
            },
            produces = "application/json"
    )
