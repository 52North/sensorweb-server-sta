...
public class HibernateSpatialCriteriaBuilderImpl extends CriteriaBuilderImpl
        implements
        HibernateSpatialCriteriaBuilder {
    ...
    @Override
    public Predicate st_equals(Expression<Geometry> x, String wktWithType) {
        return defaultSTMethodCallGeometry("ST_EQUALS", x, wktWithType);
    }

    @Override
    public Predicate st_disjoint(Expression<Geometry> x, String wktWithType) {
        return defaultSTMethodCallGeometry("ST_DISJOINT", x, wktWithType);
    }

    @Override
    public Predicate st_touches(Expression<Geometry> x, String wktWithType) {
        return defaultSTMethodCallGeometry("ST_TOUCHES", x, wktWithType);
    }

    @Override
    public Predicate st_within(Expression<Geometry> x, String wktWithType) {
        return defaultSTMethodCallGeometry("ST_WITHIN", x, wktWithType);
    }

    @Override
    public Predicate st_overlaps(Expression<Geometry> x, String wktWithType) {
        return defaultSTMethodCallGeometry("ST_OVERLAPS", x, wktWithType);
    }

    @Override
    public Predicate st_crosses(Expression<Geometry> x, String wktWithType) {
        return defaultSTMethodCallGeometry("ST_CROSSES", x, wktWithType);
    }

    @Override
    public Predicate st_contains(Expression<Geometry> x, String wktWithType) {
        return defaultSTMethodCallGeometry("ST_CONTAINS", x, wktWithType);
    }

    @Override
    public Predicate st_intersects(Expression<String> x, String wktWithType) {
        return this.isTrue(
                           this.function("ST_Intersects",
                                         Boolean.class,
    ...
    @Override
    public Predicate st_relate(Expression<Geometry> x, String wktWithType, String mask) {
        return this.isTrue(
                           this.function("ST_RELATE",
                                         Boolean.class,
    ...
    @Override
    public Expression<Float> st_length(Expression<Geometry> x) {
        return this.function(ST_LENGTH,
                             Float.class,
                             this.function(GEOGRAPHY, Geometry.class, x));
    }

    @Override
    public Expression<Float> st_length(String wkt) {
        return this.function(ST_LENGTH,
                             Float.class,
    ...
    @Override
    public Expression<Float> st_distance(Expression<Geometry> x, String wkt) {
        return this.function(ST_DISTANCE,
                             Float.class,
                             this.function(GEOGRAPHY, Geometry.class, x),
                             geographyfromWKT(extractWKT(wkt)));
    }
    ...
    @Override
    public Expression<Float> st_distance(String x, String wkt) {
        return this.function(ST_DISTANCE,
                             Float.class,
    ...
    private Predicate defaultSTMethodCallGeometry(String methodName, Expression<Geometry> x, String wktWithType) {
        return this.isTrue(this.function(methodName,
                                         Boolean.class,
                                         this.function(GEOMETRY, Geometry.class, x),
                                         geometryfromWKT(extractWKT(wktWithType))));
    }
